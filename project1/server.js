...
if (!GEMINI_API_KEY) {
  console.warn('⚠️  GEMINI_API_KEY not found in .env – falling back to FAQ mode.');
}
...
async function getGeminiResponse(userMessage, history) {
  ...
  const body = {
    system_instruction: {
      parts: [{
        text: `You are Aether, a friendly and knowledgeable AI assistant. 
...
Keep responses friendly and engaging. If asked about your identity, say you are Aether, an AI assistant.`
      }]
    },
    contents,
    generationConfig: {
